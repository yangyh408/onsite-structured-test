...
from .elements.roadtype import RoadType, Speed as RoadTypeSpeed
from .elements.roadElevationProfile import ElevationRecord as RoadElevationProfile
    ...
    for sideTag, newSideLanes in sides.items():
        ...
        for lane in side.findall("lane"):
            ...
            for markIdx, roadMark in enumerate(lane.findall("roadMark")):
                ...
                if new_lane.road_marks:
                    new_lane.road_marks[-1]["end_offset"] = float(roadMark.get("sOffset"))
